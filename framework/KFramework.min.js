var VERSION='1.0.3';require('framework/Constants.js');require('framework/tools/String.js');require('framework/tools/Object.js');require('framework/tools/Array.js');require('framework/core/Logger.js');require('framework/core/Database.js');require('framework/core/Cronjob.js');require('framework/core/Bot.js');require('framework/core/KCode.js');require('framework/core/KBank.js');require('framework/core/KConfig.js');require('framework/core/Channel.js');require('framework/core/User.js');var Status={Newbie:0,Family:1,Stammi:2,Ehrenz:3,Admin:6,Sysadmin:11,Bot:-1};var Alignment={LEFT:'°>LEFT<°',MIDDLE:'°>CENTER<°',CENTER:'°>CENTER<°',RIGHT:'°>RIGHT<°',JUSTIFY:'°>JUSTIFY<°',};if(!Object.prototype.each){Object.defineProperty(Object.prototype,'each',{enumerable:false,configurable:false,writable:false,value:function(callback){for(var index in this){if(this.hasOwnProperty(index)){continue;}
...
output+=_size+'°';return output;};KFont(name,style,size);}var VERSION='1.0.3';require('framework/Constants.js');require('framework/tools/String.js');require('framework/tools/Object.js');require('framework/tools/Array.js');require('framework/core/Logger.js');require('framework/core/Database.js');require('framework/core/Cronjob.js');require('framework/core/Bot.js');require('framework/core/KCode.js');require('framework/core/KBank.js');require('framework/core/KConfig.js');require('framework/core/Channel.js');require('framework/core/User.js');var Status={Newbie:0,Family:1,Stammi:2,Ehrenz:3,Admin:6,Sysadmin:11,Bot:-1};var Alignment={LEFT:'°>LEFT<°',MIDDLE:'°>CENTER<°',CENTER:'°>CENTER<°',RIGHT:'°>RIGHT<°',JUSTIFY:'°>JUSTIFY<°',};if(!Object.prototype.each){Object.defineProperty(Object.prototype,'each',{enumerable:false,configurable:false,writable:false,value:function(callback){for(var index in this){if(this.hasOwnProperty(index)){continue;}
if(callback.apply(this[index],index)===false){break;}}}});}
if(!Object.prototype.sort){Object.defineProperty(Object.prototype,'sort',{enumerable:false,configurable:false,writable:false,value:function(byKey,order){if(byKey===undefined){byKey=='index';}
if(order===undefined){order=='ASC';}
var keys=[];for(var index in this){var sortby=0;if(byKey=='index'){sortby=index;}else if(byKey=='value'){sortby=this[index];}else if(this[index].hasOwnProperty(byKey)){sortby=this[index][byKey];}
...
return nickname;};}());var VERSION='1.0.3';require('framework/Constants.js');require('framework/tools/String.js');require('framework/tools/Object.js');require('framework/tools/Array.js');require('framework/core/Logger.js');require('framework/core/Database.js');require('framework/core/Cronjob.js');require('framework/core/Bot.js');require('framework/core/KCode.js');require('framework/core/KBank.js');require('framework/core/KConfig.js');require('framework/core/Channel.js');require('framework/core/User.js');var Status={Newbie:0,Family:1,Stammi:2,Ehrenz:3,Admin:6,Sysadmin:11,Bot:-1};var Alignment={LEFT:'°>LEFT<°',MIDDLE:'°>CENTER<°',CENTER:'°>CENTER<°',RIGHT:'°>RIGHT<°',JUSTIFY:'°>JUSTIFY<°',};if(!Object.prototype.each){Object.defineProperty(Object.prototype,'each',{enumerable:false,configurable:false,writable:false,value:function(callback){for(var index in this){if(this.hasOwnProperty(index)){continue;}
if(callback.apply(this[index],index)===false){break;}}}});}
if(!Object.prototype.sort){Object.defineProperty(Object.prototype,'sort',{enumerable:false,configurable:false,writable:false,value:function(byKey,order){if(byKey===undefined){byKey=='index';}
if(order===undefined){order=='ASC';}
var keys=[];for(var index in this){var sortby=0;if(byKey=='index'){sortby=index;}else if(byKey=='value'){sortby=this[index];}else if(this[index].hasOwnProperty(byKey)){sortby=this[index][byKey];}
